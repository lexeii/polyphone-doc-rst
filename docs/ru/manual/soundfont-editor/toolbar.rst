...
|sample| Новый семпл
  |br| Добавить новые :ref:`семплы <sample editor>` в SoundFont.
  Polyphone импортирует звуковые файлы в форматах :file:`.wav` и :file:`.flac`.
|instrument| Новый инструмент
  |br| Создать новый :ref:`инструмент <instrument editor>`.
|preset| Новый пресет
  |br| Cоздать новый :ref:`пресет <preset editor>`.
|tools| Средства
  |br| В этом меню перечисляются :ref:`средства <tool menu>`, доступные для выбранных в :ref:`дереве <tree>` элементов.
|undo| Отменить
  |br| Отменить последние изменения.
|redo| Повторить
  |br| Повторить последние отменённые изменения.
|save| Сохранить файл
  |br| Сохранить SoundFont.
...
:kbd:`Ctrl`\ +\ :kbd:`K`
  |br| Переключиться на виртуальную клавиатуру.
...
:kbd:`Ctrl`\ +\ :kbd:`1`, :kbd:`Ctrl`\ +\ :kbd:`2`, … :kbd:`Ctrl`\ +\ :kbd:`8`
  |br| Изменить октавы компьютерной клавиатуры.
  Самая нижняя октава — :kbd:`Ctrl`\ +\ :kbd:`1`.
  Самая высокая октава — :kbd:`Ctrl`\ +\ :kbd:`8`.

:kbd:`→` / :kbd:`←`
  |br| Воспроизвести ноту выше или ниже, чем последняя нажатая клавиша, с той же силой нажатия.
  Если при этом удерживать клавишу :kbd:`Shift`, то можно перескочить через клавишу.

:kbd:`↑` / :kbd:`↓`
  |br| Воспроизвести ту же ноту, что и у последней нажатой клавиши, но с большей или меньшей силой нажатия.
