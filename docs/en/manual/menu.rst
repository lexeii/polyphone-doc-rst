...
:Open: Open an :ref:`.sf2 <sf2 format>`, :ref:`.sf3 <sf3 format>`,
  :ref:`.sfz <sfz format>` or :ref:`.sfArk <sfark format>` file.
...
:Export: Export and merge one or several presets from the open soundfonts
  in the :ref:`.sf2 <sf2 format>`, :ref:`.sf3 <sf3 format>`
  or :ref:`.sfz <sfz format>` format.
...
:About Polyphone…: Show the software version and the list of people
